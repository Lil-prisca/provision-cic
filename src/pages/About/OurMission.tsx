  ...
  return (
    <div>
      <div className="flex flex-col !mt-[60px] !m-auto max-w-[400px] md:max-w-[1279px] ">
        ...
        <div className="flex flex-col gap-[48px] !m-auto max-w-[400px] lg:max-w-[1279px] lg:flex-row lg:gap-[42px] ">
          {/*  */}
          {/* statements-container  */}
          <div className="w-[400px] h-[280px]  rounded-[16px] !pt-3 bg-[#000000]/5   lg:w-[500px] lg:h-[320px]">
            {/*  */}
            {/* mission container */}
            <div className="w-[366px] h-[256px] !mx-auto  !px-[16px] !py-4 bg-[white] rounded-[15px] gap-5! lg:w-[450px] lg:h-[285px]">
              {/*  */}
