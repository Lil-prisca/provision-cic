...
import image1 from "../../assets/fluent-mdl2_commitments.png";
// import image2 from "";
// import image3 from "";
// import image4 from "";
...
const accoProvd = [
  {
    image: "../../assets/fluent-mdl2_commitments.png",
  ...
  {
    image: "../../assets/accomodation/eos-icons_trusted-organization.png",
  ...
  {
    image: "..//../assets/accomodation/mdi_finance.png",
  ...
  {
    image: "../../assets/accomodation/fluent_people-team-20-filled.png",
...
const AccomodationProvides = () => {
  return (
    <div className="flex flex-col gap-[11px] mt-[30px]! bg-amber-700 text-[white] m-auto! max-w-[350px]  md:flex-row md:flex-wrap  lg:max-w-[1330px] md:max-h-[830px] md:m-auto!">
      {accoProvd.map((item, index) => (
        <div
          key={index}
          className="flex flex-col bg-[#2C2C2C] max-w-[350] max-h-[215.38] rounded-[12.92px] pt-[24.54px]! pl-[30.69px]! pb-[20px]! gap-[10.15px] lg:max-w-[650px] lg:max-h-[400px] md:rounded-[24px]"
        >
          <img
            className="max-w-[37.69px] max-h-[37.69px] md:max-w-[70px] md:max-h-[70px]"
            src={item.image}
            alt={item.title}
          />
          <h2 className="text-[17.23px] md:text-[32px] ">{item.title}</h2>
          <p className="text-[8.62px] max-h-[87px] max-w-[291.31px] md:text-[16px] md:max-h-[158px]    md:max-w-[541px]">
            {item.content}
          </p>
        </div>
      ))}
