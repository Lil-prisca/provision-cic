...
import maskedgroup from "../../assets/Mask group (2).png";
import maskedgroup2 from "../../assets/Group 21.png";
  ...
  return (
    <div className="max-w-[370px] mt-[50px]! max-h-[396px] m-auto!  md:max-w-[1321.49px] md:max-h-[1306.68px] md:mt-[100px]!">
      ...
      <div className="md:max-w-[1321.49] md:max-h-[1204.68px]">
        ...
        <div className=" flex  max-w-[370px] mt-[10px]! m-auto!   max-h-[151px]  md:max-w-[692.74px]! md:max-h-[665.29px] lg:max-w-[992.74px]! ">
          <p className="text-[8.4px] m-auto! md:text-[15px]   lg:text-[25px] md:max-w-[450px] md:max-h-[320px] lg:max-w-[581px]">
            Our strategically located accommodations are designed to meet the
            unique requirements of our residents. Embracing communal living, our
            residents share essential facilities such as kitchens and bathrooms
            while enjoying individual bedrooms and well-maintained communal
          ...
          <div className="max-w-[139.99px] mr-[20px]!  max-h-[151.02px] md:max-w-[387.74px] md:max-h-[365.29px] lg:max-w-[457.74px] lg:max-h-[435.29px]">
            <img className="" src={maskedgroup2} alt="" />
          </div>
        </div>
      </div>
    </div>
